 ...
 */
final class Version20200125195837 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_product (id INT NOT NULL, owner_id INT NOT NULL, payment_method_id INT NOT NULL, market_product_id INT DEFAULT NULL, purchase_id INT NOT NULL, market_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, price VARCHAR(150) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, date_of_purchase TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE INDEX IDX_8B471AA7558FBEB9 ON user_product (purchase_id)');
        $this->addSql('CREATE INDEX IDX_8B471AA7622F3F37 ON user_product (market_id)');
        ...
        $this->addSql('CREATE TABLE purchase_check (id INT NOT NULL, market_id INT NOT NULL, purchase_id INT NOT NULL, payment_method_id INT NOT NULL, market_product_id INT NOT NULL, product_name VARCHAR(255) NOT NULL, price VARCHAR(100) NOT NULL, serial_number VARCHAR(200) DEFAULT NULL, file_path VARCHAR(200) DEFAULT NULL, date_of_purchase TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_E8452F392B7A3246 ON purchase_check (market_product_id)');
        ...
        $this->addSql('ALTER TABLE user_product ADD CONSTRAINT FK_8B471AA7558FBEB9 FOREIGN KEY (purchase_id) REFERENCES purchases (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE user_product ADD CONSTRAINT FK_8B471AA7622F3F37 FOREIGN KEY (market_id) REFERENCES markets (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE purchase_check ADD CONSTRAINT FK_E8452F392B7A3246 FOREIGN KEY (market_product_id) REFERENCES market_products (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE purchase_check DROP CONSTRAINT FK_E8452F392B7A3246');
        $this->addSql('ALTER TABLE user_product DROP CONSTRAINT FK_8B471AA7622F3F37');
        ...
        $this->addSql('ALTER TABLE user_product DROP CONSTRAINT FK_8B471AA7558FBEB9');
