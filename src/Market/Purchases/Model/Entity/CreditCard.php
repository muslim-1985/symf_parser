...
class CreditCard
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Purchases\Entity\PaymentMethod", inversedBy="creditCards")
     * @ORM\JoinColumn(nullable=false)
     */
    private $paymentMethod;

    /**
     * @ORM\ManyToOne(targetEntity="App\User\Entity\User", inversedBy="creditCards")
     * @ORM\JoinColumn(nullable=false)
     */
    private $owner;
